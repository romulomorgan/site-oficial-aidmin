...
import { PenTool, MessageSquare, FileText, Settings, Home, LogOut } from 'lucide-react';
        ...
        <SidebarFooter className="border-t p-4 mt-auto">
          <div className="flex justify-between items-center">
            ...
            <button 
              ...
              className="flex items-center gap-2 text-sidebar-foreground hover:text-[#ff196e] transition-colors"
            >
              <LogOut size={16} />
              <span>Sair</span>
            </button>
