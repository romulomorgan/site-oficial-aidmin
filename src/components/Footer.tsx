...
const Footer = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (webhookUrl) {
        // Enviar para o webhook usando o hook personalizado
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 lg:col-span-1">
            <div className="mb-4">
              <img src="/lovable-uploads/3a83de09-ec2f-4458-96fa-750a22731ea4.png" alt="Logo iAdmin" className="h-12" />
            </div>
            <p className="text-gray-400 mb-4">
              Transforme seu atendimento com soluções inteligentes de IA, automatize respostas e gerencie seus clientes com eficiência.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">contato@iadmin.com.br</li>
        ...
        <div className="border-t border-gray-800 pt-6 mt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">© 2023 iAdmin. Todos os direitos reservados.</p>
