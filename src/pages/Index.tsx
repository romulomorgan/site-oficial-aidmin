            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                <div className="text-center">
                  <h3 className="text-[#FF196E] text-3xl font-bold">{siteTexts.statsYears?.toString() || '3+'}</h3>
                  <p className="text-[#222]/70 text-sm">Anos de experiência</p>
                </div>
                <div className="text-center">
                  <h3 className="text-[#FF196E] text-3xl font-bold">{siteTexts.statsProjects?.toString() || '600+'}</h3>
                  <p className="text-[#222]/70 text-sm">Projetos executados</p>
                </div>
                <div className="text-center">
                  <h3 className="text-[#FF196E] text-3xl font-bold">{siteTexts.statsCompanies?.toString() || '40+'}</h3>
                  <p className="text-[#222]/70 text-sm">Empresas atendidas</p>
                </div>
                <div className="text-center">
                  <h3 className="text-[#FF196E] text-3xl font-bold">{siteTexts.statsAutomations?.toString() || '47k+'}</h3>
